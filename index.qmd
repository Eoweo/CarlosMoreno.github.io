...
<img class="portfolio-image asset-cover" src="imagenes/Trabajando.png" alt="Foto principal / retrato técnico" loading="eager" decoding="async" fetchpriority="high" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
...
<img class="portfolio-image asset-contain" src="imagenes/Tesis_Equipo.png" alt="Equipo actual de la investigación de magíster" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
