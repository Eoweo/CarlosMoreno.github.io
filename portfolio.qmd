...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/Tesis_Completo.jpeg" alt="Montaje completo de la tesis" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/Tesis_Setup.png" alt="Setup experimental de perfusión hepática" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    SETUP EXPERIMENTAL
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/Tesis_Oxigenador.png" alt="Oxigenador del sistema de perfusión" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    OXIGENADOR
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/Tesis_Monitor2canales.jpeg" alt="Software de monitorización funcionando" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/cybathlon_aeropuerto.png" alt="Equipo Ciervo UC durante el viaje a CYBATHLON" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    EQUIPO CIERVO UC
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/cybathlon_apoyo.jpeg" alt="Trabajo técnico y apoyo en CYBATHLON" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/cybathlon_Compitiendo.png" alt="Ciervo UC compitiendo en CYBATHLON 2024" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/cybathlon_diagrama.jpeg" alt="Diagrama técnico de CYBATHLON" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/Candel_pcb.png" alt="PCB de CandelStim" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    PCB / ELECTRÓNICA
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/candel_dds.png" alt="DDS y generación de señal CandelStim" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/Candel_Software.png" alt="Software de CandelStim" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    SOFTWARE
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/Borealis_equipo.jpeg" alt="Equipo experimental Borealis UC" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/Borealis_liver2.png" alt="Hígado en proyecto Borealis" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    MODELO EXPERIMENTAL
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/Borealis_Grafico2.png" alt="Gráfico experimental Borealis" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/Ipre.gif" alt="Visualización IPRE U-Net" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/ipre_graph.png" alt="Gráfico IPRE U-Net" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    GRÁFICO IPRE / U-NET
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/vscan_solo.png" alt="Diseño Vscan Air" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    DISEÑO / DISPOSITIVO
...
<div class="image-slot">
  <img class="portfolio-image asset-contain" src="imagenes/Vscan_3dReal.png" alt="Prototipo físico Vscan Air" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    PROTOTIPO FÍSICO
...
<div class="image-slot large">
  <img class="portfolio-image asset-contain" src="imagenes/Vscan_uso1.png" alt="Uso del prototipo Vscan Air" loading="lazy" decoding="async" onload="this.hidden=false;this.parentElement.classList.add('has-image')" onerror="this.hidden=true;this.parentElement.classList.remove('has-image')">
  <div class="slot-label">
    PROTOTIPO EN USO
